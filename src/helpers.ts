...
import { Field, Interface, Type, Union } from 'graphql-codegen-core';
import {
  convertedType,
...
export const getFieldType = convert => (
  field: Field,
...
export const getFieldResolver = convert => (
  field: Field,
  type: Type,
  options: Handlebars.HelperOptions
) => {
  ...
  const isSubscription =
    subscriptionType && subscriptionType.name === type.name;
